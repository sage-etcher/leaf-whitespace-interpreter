...
# Binary Releases
If you prefer pre-compiled binaries you can find them *[here](https://github.com/sage-etcher/leaf-whitespace-interpreter/releases/latest)*. However, please note that the binaries offer less customizability.
